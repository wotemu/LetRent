...
export class PropertyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.mapsAPILoader.load().then(() => {
      ...
      autocomplete.addListener("place_changed", () => {
        this.ngZone.run(() => {
          ...
          console.log("Name is " + place.geometry.location.toString);
          //verify result
          ...
          console.log("locationLatitude is " + this.latitude);
          console.log("locationLongitude is " + this.longitude);
          this.zoom = 12;
        });
      });
    });
    ...
    this.form = this.formBuilder.group({
      ...
      weeklyPrice: [null, [Validators.required, priceConfirming]],
